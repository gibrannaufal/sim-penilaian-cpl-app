...
@Component({
  selector: 'app-detail-nilai-cpmk-mahasiswa',
  templateUrl: './detail-nilai-cpmk-mahasiswa.component.html',
  styleUrls: ['./detail-nilai-cpmk-mahasiswa.component.scss']
})
export class DetailNilaiCpmkMahasiswaComponent implements OnInit {
  @Input() nrp: number;
