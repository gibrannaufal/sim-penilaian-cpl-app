...
@Component({
  selector: 'app-list-nilai-sub-cpmk',
  templateUrl: './list-nilai-sub-cpmk.component.html',
  styleUrls: ['./list-nilai-sub-cpmk.component.scss']
})
export class ListNilaiSubCpmkComponent implements OnInit{
  rekapNilaiCpmk: [];
